...
function ehPerguntaPreco(t) {
  const texto = String(t || '');
  return texto.includes('QUAL E O PRECO') || texto.includes('QUAL O PRECO') || texto.includes('VALOR') || texto.includes('QUANTO CUSTA') || texto.includes('PRECO') || texto.includes('PREÇO');
}
